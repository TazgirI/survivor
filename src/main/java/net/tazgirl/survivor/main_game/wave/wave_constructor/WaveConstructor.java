package net.tazgirl.survivor.main_game.wave.wave_constructor;
...
import net.tazgirl.survivor.main_game.mobs.wave_mobs.CachedWaveMob;
import net.tazgirl.survivor.main_game.mobs.wave_mobs.WaveMobActiveSet;
...
public class WaveConstructor
{
    ...
    public static Wave constructWave(int mobPoints, int modifierPoints, WaveMobStorageSet set)
    {
        ...
        Map<Entity, ActiveMob<?>> activeMobs = new HashMap<>();
