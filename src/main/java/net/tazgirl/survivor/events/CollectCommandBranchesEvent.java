...
{
    private Map<String, ArgBranch[]> branchesMap = new HashMap<>();
    ...
    public void AddBranch(String branchName, ArgBranch[] branchFuncs)
    {
        branchesMap.put(branchName, branchFuncs);
    }

    public Map<String, ArgBranch[]> GetBranchesList()
    {
